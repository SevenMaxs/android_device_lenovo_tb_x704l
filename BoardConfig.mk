DEVICE_TREE := device/lenovo/tb_x704l
...
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 androidboot.console=ttyHSL0 androidboot.hardware=qcom msm_rtb.filter=0x237 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 androidboot.bootdevice=7824900.sdhci earlycon=msm_hsl_uart,0x78af000 g_android.luns=1 g_android.removable=1
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 56555445248
